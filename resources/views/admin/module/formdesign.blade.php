...
<ul class="nav nav-tabs" style="margin-bottom:10px;">
	...
	<li class="active" ><a href="{{ URL::to('admin/module/formdesign/'.$module_name)}}">Form Layout</a></li>
</ul>
...
<div class="sbox">
 ...
 {!! Form::open(array('url'=>'admin/module/formdesign/'.$module_name,'id'=>'doReorder', 'class'=>'form-vertical','parsley-validate'=>'','novalidate'=>' ')) !!}
