...
@endif
 ...
 {!! Form::open(array('url'=>'admin/module/savetable/'.$module_name, 'class'=>'form-horizontal')) !!}
<div class="sbox">
	<div class="sbox-title"><h5> 表格  </h5></div>
	 ...
	 <div class="table-responsive">
			...
			<thead class="no-border">
			  <tr>
				...
				<th scope="col"><i class="icon-link">外链</i></th>
				<th scope="col" data-hide="phone">标题 / 描述 </th>
				<th scope="col" data-hide="phone">显示</th>
				<th scope="col" data-hide="phone">View </th>
				<th scope="col" data-hide="phone">可分类</th>
				<th scope="col" data-hide="phone">下载</th>
				<th scope="col" data-hide="phone"> 格式 </th>
			  </tr>
			 </thead> 
			...
			<?php usort($tables, "SiteHelpers::_sort"); ?>
			  ...
			  <tr >
				...
				<span class=" xlick @if(isset($rows['conn']['valid']) && $rows['conn']['valid'] =='1') text-danger @endif " title="Lookup Display" 
					...
					onclick="SximoModal('{{ URL::to('admin/module/conn/'.$row->module_id.'?field='.$rows['field'].'&alias='.$rows['alias']) }}' ,' Connect Field : {{ $rows['field']}} ' )"
					>
