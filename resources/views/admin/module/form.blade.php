  ...
  <div class="page-content row">
    ...
    <div class="page-header">
      <div class="page-title">
        <h3> 表单编辑: {{ $row->module_name }} <small> 编辑表单信息 </small></h3>
      </div>
      <ul class="breadcrumb">
...
<ul class="nav nav-tabs" style="margin-bottom:10px;">
  	<li class="active" ><a href="{{ URL::to('admin/module/form/'.$module_name)}}">表单 </a></li>
  	<li  ><a href="{{ URL::to('admin/module/subform/'.$module_name)}}">Sub Form </a></li>
	<li ><a href="{{ URL::to('admin/module/formdesign/'.$module_name)}}">Form Layout</a></li>
	
</ul>
  
<div class="sbox">
	<div class="sbox-title"><h5> 表单表格  </h5></div>
	<div class="sbox-content">	
 {!! Form::open(array('url'=>'admin/module/saveform/'.$module_name, 'class'=>'form-horizontal')) !!}
 <div class="table-responsive">
		...
		<thead class="no-border">
          <tr >
            ...
            <th scope="col" data-hide="phone">标题 / 描述 </th>

			<th scope="col" data-hide="phone">类型 </th>
            <th scope="col" data-hide="phone">显示</th>
            
            <th scope="col" data-hide="phone">可搜索</th>
			<th scope="col" data-hide="phone">必须</th>
            <th scope="col">&nbsp;</th>
          </tr>
		  </thead>
	...
	?>
		<select name="required[<?php echo $id;?>]" id="required" class="form-control" style="width:150px;" >
			<option value="0" <?php if($rows['required'] == 1) echo 'selected="selected"';?>>不验证</option>
			...
			onclick="SximoModal('{{ URL::to('admin/module/editform/'.$row->module_id.'?field='.$rows['field'].'&alias='.$rows['alias']) }}','Edit Field : <?php echo $rows['field'];?>')">
