...
<div class="sbox">
    ...
    {!! Form::open(array('url'=>'admin/module/savesub/'.$module_name, 'class'=>'form-horizontal  ')) !!}
    ...
    <tbody class="no-border-x no-border-y"> 
      ...
      <tr>
        ...
        onclick="SximoConfirmDelete('{{ URL::to('admin/module/removesub?id='.$row->module_id.'&mod='.$rows['module']) }}');"
