     ...
     <div class="sidebar-collapse">				  
       <ul id="sidemenu" class="nav expanded-menu">
		<li class="logo-header" >
		 ...
		 <a data-toggle=""  href="{{ url('dashboard') }}"> <i class="icon-home4"></i> </a>
		 <a class="dropdown-toggle" href="{{ url('notification') }}"> <i class="icon-mail3"></i><span class="notif-alert ">0</span>  </a>
		</li>
		<li class="nav-header">
			<div class="dropdown profile-element" style="text-align:center;"> <span>
				...
				<small>{{ date("Y年m月d日 H:i:s", strtotime(Session::get('ll'))) }}</small>
				 </span> 
				 </span>
				 </a>
			</div>
