<?php 
define('CNF_APPNAME','Hao Cms');
define('CNF_APPDESC','后台管理系统 ');
define('CNF_COMNAME','HsCMS cms.haosoft.org');
define('CNF_EMAIL','info@haocms.org');
define('CNF_METAKEY','haocms, hcms, www.jisec.com, www.securlty.org, 极安全');
define('CNF_METADESC','网站描述');
define('CNF_GROUP','3');
